...
RESTPLUSLOCAL_LEVELMAX = "Maxed Experience";
...
TITAN_RESTPLUS_ABOUT = "version 1.0.0.0";

-- ***********************************************************
-- *** Color Menu ***
-- ***********************************************************
TITAN_RESTPLUS_CBLUE = "Blue";
TITAN_RESTPLUS_CCYAN = "Cyan";
TITAN_RESTPLUS_CFGREEN = "Forest Green";
TITAN_RESTPLUS_CGREEN = "Green";
TITAN_RESTPLUS_CGREY = "Grey";
TITAN_RESTPLUS_CKHAKI = "Khaki";
TITAN_RESTPLUS_CLOlive = "Light Olive";
TITAN_RESTPLUS_CMAGENTA = "Magenta";
TITAN_RESTPLUS_COWHITE = "Off White";
TITAN_RESTPLUS_COLIVE = "Olive";
TITAN_RESTPLUS_CORANGE = "Orange";
TITAN_RESTPLUS_CPURPLE = "Purple";
TITAN_RESTPLUS_CRED = "Red";
TITAN_RESTPLUS_CSALMON = "Salmon";
TITAN_RESTPLUS_CSBLUE = "Sky Blue";
TITAN_RESTPLUS_CYELLOW = "Yellow";
