	...
	args = {
		...
		General = {
			...
			args = {
				...
				HideLFGTankTaunts = {
					type = "toggle",
					name = L["Hide LFG Tank Taunts"],
					desc = L["Don't show LFG tank taunts."],
					width = "full",
					get = function(info) return WhoTaunted.db.profile.HideLFGTankTaunts; end,
					set = function(info, v) WhoTaunted.db.profile.HideLFGTankTaunts = v; end,
					order = 60
				},
				Prefix = {
					type = "toggle",
