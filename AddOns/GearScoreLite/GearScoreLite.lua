...
function GearScore_OnEvent(GS_Nil, GS_EventName, GS_Prefix, GS_AddonMessage, GS_Whisper, GS_Sender)
	...
	if ( GS_EventName == "PLAYER_EQUIPMENT_CHANGED" ) then
	    local MyGearScore, MyILevel = GearScore_GetScore(UnitName("player"), "player");
		...
		PersonaliLevelScore:SetText(MyILevel); PersonaliLevelScore:SetTextColor(Red, Green, Blue, 1)
  	end
...
PaperDollFrame:CreateFontString("PersonaliLevelScore")
PersonaliLevelScore:SetFont("Fonts\\FRIZQT__.TTF", 10)
PersonaliLevelScore:SetText("iL: 0")
PersonaliLevelScore:SetPoint("BOTTOMLEFT",PaperDollFrame,"TOPLEFT",265,-253)
PersonaliLevelScore:Show()

PaperDollFrame:CreateFontString("iLevel")
iLevel:SetFont("Fonts\\FRIZQT__.TTF", 10)
iLevel:SetText("iLevel")
iLevel:SetPoint("BOTTOMLEFT",PaperDollFrame,"TOPLEFT",265,-265)
iLevel:Show()
