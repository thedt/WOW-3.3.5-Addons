...
function BlackListOptions:IgnoreCheckButton_OnClick()
	if(1 == this:GetChecked()) then
		...
		--if(GetSelectedIgnore(BlackList:GetPlayerByIndex(BlackList:GetSelectedBlackList())) ~= nil) then
		--	AddIgnore(BlackList:GetPlayerByIndex(BlackList:GetSelectedBlackList()))
		--end
	else
		BlackListConfig.Ignore = false;
		--if(GetSelectedIgnore(BlackList:GetPlayerByIndex(BlackList:GetSelectedBlackList())) ~= nil) then
		--	DelIgnore(BlackList:GetPlayerByIndex(BlackList:GetSelectedBlackList()))
		--end
	end
end
