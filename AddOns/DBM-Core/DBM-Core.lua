...
-------------------------------
DBM = {
	Revision = ("$Revision: 4565 $"):sub(12, -3),
	Version = "4.70",
	DisplayVersion = "4.70 Warmane edit by Sariyo", -- the string that is shown as version
	ReleaseRevision = 4565 -- the revision of the latest stable version that is available (for /dbm ver2)
}
